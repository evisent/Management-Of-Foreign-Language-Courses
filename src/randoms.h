...
std::unique_ptr<Language> rand_language(){
    ...
    switch(language) {
        ...
        case 4: return std::make_unique<French>(rand_level(), rand_intensity());
        case 5: return std::make_unique<Arabian>(rand_level(), rand_intensity());
